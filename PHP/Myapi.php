    ...
    if (isset($GLOBALS['data']->type)){
        ...
        if ($GLOBALS['data']->type == "GetAllWines"){
          ...
          //if (isset($GLOBALS['data']->UserID)){
            //var_dump("Bruh");
            $sql = "SELECT fav.WineID, fav.UserID, w.Name, w.Wine_URL, w.Vintage, w.Producer, w.Category, w.Cultivars, w.Description, w.Cost_per_bottle FROM favourite_wine as fav INNER JOIN wine as w ON w.WineID=fav.WineID WHERE fav.UserID=".$GLOBALS['data']->userID;
        ...
        else if($GLOBALS['data']->type == "getAllBusinessWines"){
          ...
          if($stmt->rowCount() > 0) {
              ...
              failure("No events associated with business {$GLOBALS['data']->businessID} in DB");
          }

      }

      else if($GLOBALS['data']->type == "addBusinessEvent"){
      ...
      else if($GLOBALS['data']->type == "updateBusinessEvent"){
      ...
      else if($GLOBALS['data']->type == "removeBusinessEvent"){
      ...
      else if($GLOBALS['data']->type == "updateBusinessNumber"){
      ...
      else if($GLOBALS['data']->type == "updateBusinessEmail"){
