...
function getData() {
    ...
    const requestBody = {
        ...
        "userEmail": document.getElementById('Email').value  // change for each user
    };
...
function updateInfo() {
    ...
    var requestBody = {
      "type": "updateUserInfo",
      "api_key": document.getElementById('API_Key').value, //change for users
      "userEmail": document.getElementById('Email').value , // change for users
      "FirstName": firstName,
    ...
    var requestBody_2 = {
      ...
      "api_key": document.getElementById('API_Key').value, //change for users
      "userID": document.getElementById('UserID').value , // change for users
      "Country": country,
      "RegionName": region
    };
