...
<body style="padding-top: 140px">
    ...
    <div class="container">
      ...
      <div id="navmenu">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item" style="padding-right: 25px">
            <a href="wineries.php" id="exploreWineries" class="nav-link" style="color: #00192b">Explore Vineyards</a>
          </li>
  ...
  <script>
    ...
    var exploreWines = document.getElementById("exploreWines");
    exploreWines.addEventListener("click", function() {
      window.location.href = "wines.php"; // Navigate to the explore page
    });
  </script>
  <script>
    // Add event listener to the explore button
    var exploreWineries = document.getElementById("exploreWineries");
    exploreWineries.addEventListener("click", function() {
      window.location.href = "wineries.php"; // Navigate to the explore page
    });
  </script>
</body>
