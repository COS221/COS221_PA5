...
CREATE TABLE `lot` (  /*populated*/
`Lot_ID` int NOT NULL AUTO_INCREMENT,
`Business_ID` int NOT NULL,
PRIMARY KEY (`Lot_ID`,`Business_ID`),
...
CREATE TABLE `wine_lot` ( /*populated*/
`WineID` int NOT NULL,
`Lot_ID` int NOT NULL,
`WineQuantity` int NOT NULL,
PRIMARY KEY (`WineID`,`Lot_ID`),
KEY `LotIDwlot_idx` (`Lot_ID`),
CONSTRAINT `LotIDwlot` FOREIGN KEY (`Lot_ID`) REFERENCES `lot` (`Lot_ID`),
CONSTRAINT `WineIDwlot` FOREIGN KEY (`WineID`) REFERENCES `wine` (`WineID`)
);
...
CREATE TABLE `recommendations` (  /*populate*/
`RecID` int NOT NULL AUTO_INCREMENT,
`WineID` int NOT NULL,
`BusinessID` int NOT NULL,
PRIMARY KEY (`RecID`,`WineID`,`BusinessID`),
UNIQUE KEY `RecID_UNIQUE` (`RecID`),
KEY `WineID_idx` (`WineID`),
KEY `BusinessID_idx` (`BusinessID`),
KEY `WineIDRec_idx` (`WineID`),
KEY `BusinessIDRec_idx` (`BusinessID`),
CONSTRAINT `BusinessIDRec` FOREIGN KEY (`BusinessID`) REFERENCES `business` (`Business_ID`),
CONSTRAINT `WineIDRec` FOREIGN KEY (`WineID`) REFERENCES `wine` (`WineID`)
);

INSERT INTO wine (`Name`,`Wine_URL`,`Body`,`Alcohol`,`Tannin`,`Acidity`,`Sweetness`,`Brand_Name`,`Vintage`,`Origin`, `Volume`, `Code_Num`, `Cultivars`, `Category`, `Description`, `Cost_per_bottle`, `Cost_per_glass`, `Price_Category`)
VALUES ("Lamoreaux Landing Wine Cellars Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-louis-jadot-macon-villages-internal.jpg", "full-bodied", "12.5", "high", "3.4", "Medium", "unoaked Chardonnay", "2017", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","The Finger Lakes knows how to give a lean Chardonnay some depth. The acidity in the wine is high (typical for cool-climate wines), but it is rounded out with an unctuous mouthfeel . There is a hint of tannin in the background that adds structure.","327,49","52","Premium")
,("Billsboro Winery Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-billsboro-winery-chardonnay-internal.jpg", "full-bodied", "12.3", "high", "3.4", "Medium", "unoaked Chardonnay", "2018", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","It’s lean. It’s deep. It’s in the in-between. There is ample acidity here in that cool-climate vibe but the depth on the palate gives that high tone a run for its money.","327,49","52","Premium")
,("Blenheim Vineyards Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-blenheim-vineyards-chardonnay-internal.jpg", "full-bodied", "12.2", "high", "3.4", "Medium", "unoaked Chardonnay", "2015", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","Guys, Virginia is not playing. And Blenheim isn’t either. This Chardonnay is so damn earthy with some deep honey notes winding through the fruit. The thick, palate-coating mouthfeel is lifted by wonderful acidity, allowing you to enjoy the weight and the refreshment all at once.","346,76","52","Premium")
,("Boschkloof Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-boschkloof-chardonnay-bottle-shot-charlotte-alsaadi-internal.jpg", "full-bodied", "12.0", "high", "3.4", "Medium", "unoaked Chardonnay", "2013", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","A lot of stainless steel and a little bit of oak was the approach to this bright and lively wine with soft edges. The little bit of wood comes through in texture more than aroma and that is a win. This is a no-brainer on the casual wine front.","366,02","52","Premium")
,("Weingut Franz & Christine Netzl Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-weingut-franz-christine-netzl-chardonnay-internal.jpg", "full-bodied", "12.1", "high", "3.4", "Medium", "unoaked Chardonnay", "2016", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","This is not the Chardonnay you are used to. And that’s great because this grape has multiple personalities. Here, it is all blazing acidity, blooming with ripe, round, and unoaked(?) fruit. This is so a crowd-pleasing case-buy.","385,29","52","Premium")
,("Wente Vineyards Riva Ranch Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-wente-riva-ranch-chardonnay-2019-internal.jpg", "full-bodied", "12.5", "high", "3.4", "Medium", "unoaked Chardonnay", "2017", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","This wine is just scratching the surface of what the Wente family has to offer. But start here. If you’re gonna go for a wine with toasty and deep oak, this is the way to go. It’s soft and creamy with a good lift to the palate. A great wind-down wine","385,29","52","Premium")
,("Lava Cap Winery Reserve Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-lava-cap-chardonnay-nv-internal.jpg", "full-bodied", "12.9", "high", "3.4", "Medium", "unoaked Chardonnay", "2015", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","This is volcanic Chardonnay. No, it’s not hot but from the dark soils of a lava cap in El Dorado, Calif. It’s quite fruit-forward with a waft of that volcanic, saline minerality. The oak is minimal, which is nice because there are so many other things happening in this refreshing wine.","423,82","67,8112","Super Premium")
,("Corey Creek Coquillage Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-corey-creek-cellars-coquillage-chardonnay-internal.jpg", "full-bodied", "12.0", "high", "3.4", "Medium", "unoaked Chardonnay", "2018", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","There is only one wine like this in the entire world… well… it’s this one. Coming from the North Fork of Long Island is this amazing Chardonnay that was AGED ON SEA SHELLS! It is so clean and mineral with nice mild fruit. The mouthfeel is soft and refreshing with a bit of depth and the slightest hint of briny sea shells on the finish. Run to a computer now and buy some.","462,34","52","Super Premium")
,("Black Stallion Estate Winery Heritage Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-black-stallion-winery-heritage-chardonnay-internal.jpg", "full-bodied", "12.5", "high", "3.4", "Medium", "unoaked Chardonnay", "2016", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","For the price, this wine is punching above its weight. Soft and toasty with hints of vanilla and a creamy, coating mouthfeel, this wine drinks like a more expensive wine. And the balance on the palate with good natural acidity holds up the slight weight.","481,61","52","Super Premium")
,("Domaine Skouras Dum Vinum Sperum Chardonnay","https://vinepair.com/wp-content/uploads/2023/04/btb-chardonnay-2023-skouras-dum-vinum-sperum-chardonnay-internal.jpg", "full-bodied", "12.8", "high", "3.4", "Medium", "unoaked Chardonnay", "2017", "Lamoreaux Landing Wine Cellars", "750 ml","22042108","Cabernet Sauvignon","white","This wine is as bright and refreshing as a Greek island breeze. The fruit is nice and ripe, balanced by soft tones of butter and vanilla. The acidity is so active that it bursts through the wine, keeping you aware of the next sip.","539,40","86,304","Super Premium")

,("Dr. Konstantin Frank Old Vines Pinot Noir 2020","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-dr-konstantin-frank-pinot-noir.jpg", "full-bodied", "12.5", "high", "3.6", "High", "Pinot noir", "2020", "the Finger Lakes", "750 ml","22042108","Pinot Noir","red","From a pioneering Finger Lakes winery, this is a Pinot Noir that can compete with many from California or Oregon. Perfectly balanced with refreshing acidity and light tannins, it offers tastes of cherry, strawberry, and blueberry with an overlay of vanilla and touches of earth and cookie dough. The website says the blend includes wine from the original Pinot Noir vines planted by its founder Dr. Konstantin Frank in 1958, representing the second-oldest Pinot Noir vines in the U.S.","519,94","52","Super Premium")
,("Stony Lonesome Cabernet Sauvignon Sawmill Creek Vineyard 2020","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-sawmill-creek-cabernet-sauvignon.jpg", "full-bodied", "12.3", "high", "3.2", "Medium", "Pinot noir", "2020", "the Finger Lakes", "750 ml","22042108","Pinot noir","red","This lovely Cabernet shows true varietal character in a fresh, approachable style. A beautiful combination of concentrated dark and red fruit tastes that include dried cherry, raspberry, and blackberry accented by a mocha note. Fine tannins add to the elegance of this classy wine with under-12 percent ABV. Stony Lonesome is a label of Three Brothers Wineries & Estates on Seneca Lake.","885,82","52","Ultra Premium")
,("McGregor Vineyard Saperavi 2019","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-mcgregor-saperavi.jpg", "full-bodied", "12.2", "high", "3.4", "Medium", "Pinot noir", "2019", "the Finger Lakes", "750 ml","22042108","Saperavi ","red","Saperavi, an ancient variety originally from the country of Georgia, soars in this phenomenal wine from McGregor, which overlooks Keuka Lake and was founded in 1971. Dark, dense, and full-bodied (but with alcohol at just 12.4 percent), aromas and tastes include blackberry and violets with hints of black licorice, green olive, and orange rind. Firm tannins and refreshing acidity complete the picture. McGregor also offers Reserve and Grand Reserve Saperavis with a year or two of additional age.","1155,42","52","Luxury")
,("Wagner Vineyards Cabernet Franc 2020","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-wagner-cabernet-franc.jpg", "full-bodied", "12.0", "high", "3.7", "Medium", "Pinot noir", "2020", "the Finger Lakes", "750 ml","22042108","Cabernet","red","This elegant wine, an under-$20 value, evokes some of the Cabernet Francs of France’s Loire Valley. Initial tastes of sour cherry and pomegranate give way to darker fruit notes as it opens up. There’s a touch of leafiness, which is typical of young Cab Franc. A refreshing wine of balance and complexity that will evolve for several years and is perfect for lighter foods, including white meats and fish.","365,88","52","Premium")
,("Toast Winery Zweigelt 2021","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-toast-zweigelt.jpg", "full-bodied", "12.1", "high", "3.3", "Medium", "Pinot noir", "2021", "the Finger Lakes", "750 ml","22042108","Pinot noir","red","Great acidity and freshness in this Austrian variety make it a superb food wine. It’s rather Beaujolais-like in taste and feel, with notes of sour cherry and blueberry and hints of vanilla and forest floor. It was perfect with a shrimp and vegetable risotto, neither overpowering, nor overpowered by, the food.","462,17","52","Super Premium")
,("Weis Vineyards Blaufränkisch 2020","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-weis-blaufrankisch.jpg", "full-bodied", "12.5", "high", "3.4", "Medium", "Pinot noir", "2020", "the Finger Lakes", "750 ml","22042108","Pinot noir","red","This stellar wine makes a convincing case for the importance of Blaufränkisch in the Finger Lakes. Savory, with notes of blackberry, plum, and overripe strawberry, the wine is lively and lean with an impressively long finish that beckons you for the next sip. A serious wine that should be compared with Blaufränkisches from Austria.","500,68","52","Super Premium")
,("Fox Run Vineyards Unoaked Lemberger (Blaufränkisch) 2021","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-fox-run-lemberger.jpg", "full-bodied", "12.9", "high", "3.1", "Medium", "Pinot noir", "2021", "the Finger Lakes", "750 ml","22042108","Pinot noir","red","Another wine that evokes young Beaujolais in its lightness and fruitiness with aromas and concentrated tastes of blackberry and blueberry compote and white pepper on the finish. With ample acidity, this will be a summer hit with a slight chill for all kinds of foods and for sipping on its own.","385,142","67,8112","Super Premium")
,("Lakewood Vineyards Cabernet Franc 2020","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-lakewood-cabernet-franc.jpg", "full-bodied", "12.0", "high", "3.2", "Medium", "Pinot noir", "2020", "the Finger Lakes", "750 ml","22042108","Pinot noirn","red","There’s lots of complexity in this Cab Franc, with blueberry and cranberry notes, touches of orange rind and spice, and subtle oak that provides hints of vanilla and smoke. Soft tannins round out the picture in an altogether lovely wine. Another excellent value.","385,14","52","Premium")
,("Point of the Bluff Vineyards Reserve Pinot Noir","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-point-of-the-bluff-pinot-noir.jpg", "full-bodied", "12.6", "high", "3.4", "Medium", "Pinot noir", "2020", "the Finger Lakes", "750 ml","22042108","Pinot noir","red","This delightful Pinot Noir, with ABV at just 12 percent, is complex and delicious, showing aromas and tastes of cherry, raspberry, and blueberry. The concentrated fruit is framed by lively acidity and accented by touches of earth, cinnamon, and vanilla. The winery on Keuka Lake claims on its website that its Pinot Noir “has the elegance and finesse of some of the best wine around the world.” I won’t disagree.","673,99","52","Ultra Premium")
,("Heron Hill Winery Blaufränkisch Ingle Vineyard 2020","https://vinepair.com/wp-content/uploads/2023/03/good-wines-reds-finger-lakes-internal-heron-hill-blaufrankisch.jpg", "full-bodied", "12.1", "high", "3.4", "Medium", "Pinot noir", "2020", "the Finger Lakes", "750 ml","22042108","Pinot noir","red","This delicate and expressive Blaufränkisch shows dark fruit tastes, including cassis and black cherry, with secondary notes of white pepper, black licorice, and flowers. All of it is supported by a gentle tannic structure and balanced acidity. Serve it slightly chilled to give it an even more refreshing lift.","673,99","86,304","Ultra Premium");
...
INSERT INTO user (`First_name`,`Middle_name` ,`Last_name` ,`Region_id` ,`Password` ,`Salt` ,`Pepper` ,`Email` ,`API_Key` ,`PhoneNumber`)
VALUES ("Emily","Grace","Anderson",4,"7G83hB9e5N","Salt","Peper","emily.anderson@example.com","7G83hB9e5N","+1 555-123-4567")
,("Jacob","Alexander","Smith",4,"X6rLk0Q1uW","Salt","Peper","jacob.smith@example.com","7G83hB9e5N","+44 20 1234 5678")
,("Olivia","Rose","Johnson",4,"2vC5dY9a4I","Salt","Peper","olivia.johnson@example.com","7G83hB9e5N","+49 1234 567890")
,("Ethan","James","Thompson",5,"P3mJk6N9o2","Salt","Peper","ethan.thompson@example.com","7G83hB9e5N","+61 2 1234 5678")
,("Ava","Elizabeth","Wilson",5,"R9sUw2Z0qF","Salt","Peper","ava.wilson@example.com","7G83hB9e5N","+33 1 23 45 67 89")
,("Liam","Michael","Davis",5,"A5iG8lO9pT","Salt","Peper","liam.davis@example.com","7G83hB9e5N","+39 02 1234 5678")
,("Sophia","Marie","Taylor",6,"D4cN7uB0vE","Salt","Peper","sophia.taylor@example.com","7G83hB9e5N","+81 3 1234 5678")
,("Noah","Benjamin","Robinson",6,"H2xY1mK3nI","Salt","Peper","noah.robinson@example.com","7G83hB9e5N","+55 11 1234-5678")
,("Isabella","Grace","Martinez",6,"W8eR4yT1oL","Salt","Peper","isabella.martinez@example.com","7G83hB9e5N","+34 91 234 56 78")
,("Benjamin","Thomas","Anderson",6,"F9nI5kG3jD","Salt","Peper","benjamin.anderson@example.com","7G83hB9e5N","+61 8 8765 4321")
,("Elijah","Samuel","Harris",4,"5gW7dHjK9L","Salt","Peper","elijah.harris@example.com","7G83hB9e5N","+1 555-987-6543")
,("Charlotte","Grace","Thompson",4,"R2sT4yU6vQ","Salt","Peper","charlotte.thompson@example.com","7G83hB9e5N","+44 20 8765 4321")
,("Henry","Alexander","Davis",4,"P8bN6mJ3kX","Salt","Peper","henry.davis@example.com","7G83hB9e5N","+49 1234 5678910")
,("Emma","Rose","Carter",5,"P8bN6mJ3kX","Salt","Peper","emma.carter@example.com","7G83hB9e5N","+61 2 3456 7890")
,("Sebastian","Jameson","Wright",5,"A3nB6mG4pD","Salt","Peper","sebastian.wright@example.com","7G83hB9e5N","+33 1 2345 6789")
,("Sophie","Elizabeth","Phillips",5,"S6tY8hN1wZ","Salt","Peper","sophie.phillips@example.com","7G83hB9e5N","+39 02 9876 5432")
,("Nathan","Benjamin","Wilson",6,"D4eF9cR2vG","Salt","Peper","nathan.wilson@example.com","7G83hB9e5N","+81 3 4567 8901")
,("Ava","Sophia","Mitchell",6,"H2uT7kL5mP","Salt","Peper","ava.mitchell@example.com","7G83hB9e5N","+55 11 7890-1234")
,("Caleb","Michael","Anderson",6,"W9xR4yU1oT","Salt","Peper","caleb.anderson@example.com","7G83hB9e5N","+34 91 234 5678")
,("Isabella","Grace","Roberts",6,"F7nI2kG8jD","Salt","Peper","isabella.roberts@example.com","7G83hB9e5N","+61 8 7654 3210");
