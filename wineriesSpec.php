...
<body style="padding-top: 230px; background-color: #00192b">
  ...
  <div class="container" style="
    ...
    <div class="row">
      <div class="col-3">
        <img src="img/vineyard-placeholder.jpg" alt="vineyard-placeholder" class="displayImg" style="
              margin: 15px;
              border-radius: 15px;
              box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);
            " />
      ...
      <div class="col-4" style="margin-left: 50px; margin-top: 10px">
        <ul style="list-style-type: none">
          ...
          <li class="liDescription">
            ...
            dolorem esse facilis in, perspiciatis repudiandae et ipsam? Enim
            pariatur dolore ipsum nostrum id. Repellendus, dolor. Optio
